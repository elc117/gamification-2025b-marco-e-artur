...
public class BonecoCaminhando {
    ...
    private void initAnimations() {
        Texture spreedshetCaminhadaBaixo = new Texture("hero/Eni/baixo/RecortadaBaixo.png");
        ...
        Texture spreedshetCaminhadaCima = new Texture("hero/Eni/cima/RecortadaCima.png");
        int frameColsCima = 4;
        int frameRowsCima = 4;
        ...
        Texture spreedshetCaminhadaEsquerda = new Texture("hero/Eni/esquerda/RecortadaEsquerda.png");
        ...
        Texture spreedshetCaminhadaDireita = new Texture("hero/Eni/direita/Recortada_direita.png");
        int frameColsDireita= 4;
        int frameRowsDireita = 4;

        int frameWidthDireita = spreedshetCaminhadaEsquerda.getWidth() / frameColsDireita;
        int frameHeightDireita = spreedshetCaminhadaEsquerda.getHeight() / frameRowsDireita;
